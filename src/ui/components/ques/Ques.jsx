...
const buildShuffledAnswers = () => {
  const buffer = [...QUESTION_PAIRS];
...
const Ques = () => {
  ...
  const answersOrder = useMemo(buildShuffledAnswers, []);
      ...
      <div className="match-quiz__card">
        ...
        <section className="match-quiz__stats">
          <div className="match-quiz__stat">
            ...
            <span className="match-quiz__stat-label">правильных угадываний из {QUESTION_PAIRS.length}</span>
          </div>
          <div className="match-quiz__stat">
